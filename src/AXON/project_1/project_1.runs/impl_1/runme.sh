...
HD_PWD='D:/SEMESTER1_20252026/VLSI/WGAN-EEG-FPGA/src/AXON/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log onedconv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source onedconv.tcl -notrace
