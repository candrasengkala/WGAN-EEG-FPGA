...
HD_PWD='D:/SEMESTER1_20252026/VLSI/WGAN-EEG-FPGA/src/AXON/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lvl_io_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lvl_io_control.tcl
