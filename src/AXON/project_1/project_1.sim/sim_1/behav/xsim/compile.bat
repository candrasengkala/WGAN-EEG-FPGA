...
REM
REM Generated by Vivado on Sat Jan 17 20:42:10 +0700 2026
...
echo "xvlog --incr --relax -prj tb_top_lvl_io_control_vlog.prj"
call xvlog  --incr --relax -prj tb_top_lvl_io_control_vlog.prj -log xvlog.log
