...
REM
REM Generated by Vivado on Thu Jan 15 15:37:37 +0700 2026
...
echo "xvlog --incr --relax -prj top_lvl_tb_vlog.prj"
call xvlog  --incr --relax -prj top_lvl_tb_vlog.prj -log xvlog.log
