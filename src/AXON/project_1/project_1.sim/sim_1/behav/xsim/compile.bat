...
REM
REM Generated by Vivado on Sat Jan 24 16:01:50 +0700 2026
...
echo "xvlog --incr --relax -prj onedconv_tb_vlog.prj"
call xvlog  --incr --relax -prj onedconv_tb_vlog.prj -log xvlog.log
