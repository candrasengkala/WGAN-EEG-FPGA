...
//   Layer 9: 16 ch,  stride 1, 512 temporal, 1 filter,   kernel 7, pad 3 (FINAL OUTPUT LAYER)
//
...
module Onedconv_Scheduler_FSM #(
    ...
    // ========================================================================
    // Layer Configuration ROM (10 layers: 0-9)
    // ========================================================================
    reg [9:0] ROM_INPUT_CHANNELS [0:9];
    reg [1:0] ROM_STRIDE [0:9];
    reg [9:0] ROM_TEMPORAL [0:9];
    reg [9:0] ROM_FILTERS [0:9];
    reg [4:0] ROM_KERNEL [0:9];
    reg [2:0] ROM_PADDING [0:9];
    ...
    initial begin
        ...
        // Layer 9 - Final Output Layer (after transconv)
