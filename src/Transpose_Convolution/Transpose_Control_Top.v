 ...
 *
 * FIX (Feb 2026):
 * - Tambah port input output_busy — diteruskan ke Auto_Scheduler
 *   agar scheduler tidak transition layer saat Output_Manager masih transmit
 ******************************************************************************/
...
module Transpose_Control_Top #(
    ...
    // NEW: dari Output_Manager.transmission_active
    ...
    output wire                   batch_complete_signal,
    ...
    assign batch_complete_signal = internal_batch_complete;
    assign selector_mux_transpose = done_transpose;

    // ========================================================================
    // 1. Auto Scheduler — dengan output_busy
    // ========================================================================
    ...
    Scheduler_FSM #(
        ...
        .done             (scheduler_done),
        .batch_complete   (internal_batch_complete)
    );
